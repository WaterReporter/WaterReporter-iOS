...
class GroupsTableViewController: UITableViewController, UINavigationControllerDelegate {
    ...
    // MARK: @IBActions
    //
    @IBAction func cancelUserProfileCreateGroupsTableViewController(sender: UIBarButtonItem) {
